      ...
      >
        ...
        <div ref={footerRef} className="relative z-10 mt-auto border-t border-white/10 px-6 pb-8 pt-6">
          ...
          <a
            ...
            onClick={onClose}
            data-footer-el
            className="group/cta flex w-full items-center justify-center gap-2 rounded-2xl bg-[var(--accent)] px-6 py-4 text-sm font-bold text-[#0a0f18] transition-all duration-300 hover:bg-[var(--accent)]/90 hover:shadow-[0_0_40px_rgba(204,255,0,0.28)] active:scale-[0.97]"
          >
